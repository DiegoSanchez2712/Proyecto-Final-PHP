        ...
        <div class="form-container">
            ...
            <form action="<?= SITE_URL ?>index.php?action=registerUser" method="POST">
                ...
                <div class="form-group">
                    <label class="white-form-field">Tipo de documento</label>
                    <select name="document_type_id" id="document_type_id" required>
                        <option value="" <?php if (isset($_SESSION['old']['document_type_id']) && $_SESSION['old']['document_type_id'] === '') echo 'selected'; ?>>Seleccione una opcion</option>
                ...
                <div class="form-group">
                    <label class="white-form-field">Número de documento</label>
                ...
                <div class="form-group">
                    <label class="white-form-field">Nombre</label>
                ...
                <div class="form-group">
                    <label class="white-form-field">Apellido</label>
                ...
                <div class="form-group">
                    <label class="white-form-field">Teléfono</label>
                ...
                <div class="form-group">
                    <label class="white-form-field">Email</label>
                ...
                <div class="form-group">
                    <label class="white-form-field">Contraseña</label>
